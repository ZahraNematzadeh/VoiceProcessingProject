...
folder_path_train= '/content/drive/My Drive/Dataset/ah/test_train/ClusteredData/medium_mass/train'
folder_path_test= '/content/drive/My Drive/Dataset/ah/test_train/ClusteredData/medium_mass/val'
